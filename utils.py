...
########################### Планы на завтра ###########################
"""
- Функция создания занятия в группе
- Функция отметки посещаемости одного студента на этом занятии
- Функция отметки всех студентов на занятии (используя предыдущую функцию)
"""